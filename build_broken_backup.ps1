...
Write-Host "=== Done ==="
Write-Host "Package: $appx"
.EnhancedKeyUsageList | Where-Object {
                # build.ps1 - Build and package MC Java UWP
param(
    [string]$MesaRuntimeDir = $env:MESA_UWP_DIR,
    [string]$XboxOneGraphicsRuntimeDir = $env:XBOX_ONE_GRAPHICS_RUNTIME_DIR,
...
Write-Host "=== Done ==="
Write-Host "Package: $appx"
.FriendlyName -eq "Code Signing" -or
                # build.ps1 - Build and package MC Java UWP
param(
    [string]$MesaRuntimeDir = $env:MESA_UWP_DIR,
    [string]$XboxOneGraphicsRuntimeDir = $env:XBOX_ONE_GRAPHICS_RUNTIME_DIR,
...
$banditVaultSigningCertCandidates = @(
    $allSigningCertCandidates |
        Where-Object { # build.ps1 - Build and package MC Java UWP
param(
    [string]$MesaRuntimeDir = $env:MESA_UWP_DIR,
    [string]$XboxOneGraphicsRuntimeDir = $env:XBOX_ONE_GRAPHICS_RUNTIME_DIR,
    [string]$McVersion,
...
Write-Host "=== Done ==="
Write-Host "Package: $appx"
.Subject -notlike "*BanditVault*" -and
            # build.ps1 - Build and package MC Java UWP
param(
    [string]$MesaRuntimeDir = $env:MESA_UWP_DIR,
    [string]$XboxOneGraphicsRuntimeDir = $env:XBOX_ONE_GRAPHICS_RUNTIME_DIR,
